...
def measure_detection_performance(detections, labels, labels_valid, min_iou=0.5):
    ...
    for label, valid in zip(labels, labels_valid):
        ...
        if valid: # exclude all labels from statistics which are not considered valid
            ...
            for i in detections:
                ...
                class_id, x, y, z, h, w, l, yaw = i
                detect_corners = tools.compute_box_corners(x,y,w,l,yaw)
                ...
                detect_poly = Polygon(detect_corners)

                intersection = detect_poly.intersection(label_poly)
                union = detect_poly.union(label_poly)
    ...
    print(":::Detection Performance:::\n" + str(det_performance[0]) + "\n" + str(det_performance[1]) + "\n" +str(det_performance[2]) + "\n:::Detection Performance:::")
